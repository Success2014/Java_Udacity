...
public class Word
{
    ...
    */
    public String getPluralForm()
    {
        ...
        int nextToLast = letters.length() - 2; // index of next to last letter. NO NEED for this one, you can use last-1
        ...
        if (is(last, "y") && isConsonant(nextToLast)) 
        {
        ...
        if (is(last, "h"))
        {
            if (is(nextToLast, "s") || (is(nextToLast, "c")))
            {
                return letters + "es";
            }
        }
