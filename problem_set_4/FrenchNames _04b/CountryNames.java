...
public class CountryNames
{
    ...
    public String getCompleteName(String name)
    {
         ...
         String endLetter = name.substring(name.length()-1);
         if(endLetter.equals("s")){
             return "les " + name;
         }
         else if ("aeiouAEIOU".contains(startLetter)){
             return "l'" + name;
         }
         else if(endLetter.equals("e")){
             if (name.equals("Belize")||name.equals("Cambodge")||name.equals("Mexique")||name.equals("Mozambique")||name.equals("Zaire")||name.equals("Zimbabwe")){
                 return "le " + name;
                }
             else{
                 return "la " + name;
